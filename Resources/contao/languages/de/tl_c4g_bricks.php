...
/** FIELDS **/
$GLOBALS['TL_LANG']['tl_c4g_bricks']['brickkey'] = ['Baustein', ''];
...
$GLOBALS['TL_LANG']['tl_c4g_bricks']['copy'] = array("Einstellung kopieren","");
$GLOBALS['TL_LANG']['tl_c4g_bricks']['delete'] = array("Einstellung löschen","");
...
$GLOBALS['TL_LANG']['tl_c4g_bricks']['mapContent'] = 'Karten- und Listendaten pflegen';
$GLOBALS['TL_LANG']['tl_c4g_bricks']['routing'] = 'Routing und Umkreissuche';
