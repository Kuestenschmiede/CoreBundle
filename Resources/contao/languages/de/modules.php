 ...
 * Back end modules
 */
$GLOBALS['TL_LANG']['MOD']['con4gis'] = array('con4gis Bausteine', 'Geoinformationssysteme mit Contao.');
$GLOBALS['TL_LANG']['MOD']['c4g_bricks'] = array('Übersicht', 'Eine Übersicht aller Bausteine');
